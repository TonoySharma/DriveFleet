...
export const metadata = {
  ...
  description:
    "Manage your current, upcoming, and past car rental bookings. Track your rental status and view invoices.",
};
    ...
    <div className="min-h-screen bg-[#f5f1ea] py-16 px-4">
      <div className="max-w-7xl mx-auto mt-10">
        ...
        {!bookings || bookings.length === 0 ? (
          <div className="flex flex-col items-center justify-center bg-gradient-to-b from-white/90
           to-white/50 backdrop-blur-md rounded-3xl border border-dashed border-gray-300 shadow-md shadow-slate-100/50
            h-[400px] p-6 transition-all duration-300">
            <div className="p-4 bg-amber-50 text-amber-500 rounded-full animate-pulse">
              <TbAlertHexagonFilled className="w-10 h-10" />
            </div>
            <h3 className="mt-5 text-xl font-semibold text-slate-700 tracking-tight">
              Your booking car is empty
            </h3>
            <p className="mt-2 text-sm text-slate-400 text-center max-w-xs leading-relaxed">
              Explore our premium fleet and find the perfect ride for your next journey.
            </p>
          </div>
        ) : (
